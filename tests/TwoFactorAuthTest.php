...
//    }
    ...
    public function testEnsureAllTimeProvidersReturnCorrectTime() {
        ...
        $tfa->ensureCorrectTime(array(
            ...
            new TFAuth\Providers\Time\HttpTimeProvider(),                        // Uses google.com by default
            new TFAuth\Providers\Time\HttpTimeProvider('https://github.com'),
            new TFAuth\Providers\Time\HttpTimeProvider('https://yahoo.com'),
        ));
    }
...
//        $tfa = new TwoFactorAuth('Test');
//
//        $method = new ReflectionMethod('TFAuth\TwoFactorAuth', 'base32Decode');
...
//        $rng = new \TFAuth\Providers\Rng\MCryptRNGProvider();
//        foreach ($this->getRngTestLengths() as $l)
//            $this->assertEquals($l, strlen($rng->getRandomBytes($l)));
//        $this->assertEquals(true, $rng->isCryptographicallySecure());
//    }
